                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color:
                                  index == 0 ? themeBlue : Colors.transparent,
                              borderRadius: BorderRadius.circular(5),
                              border:
                                  Border.all(color: themeGrey.withOpacity(.4))),
                          child: Center(
                            child: Text(
                              'M-PESA Express',
                              style: TextStyle(
                                  color: index == 0 ? Colors.white : themeGrey),
                            ),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                color:
                                    index == 1 ? themeBlue : Colors.transparent,
                                borderRadius: BorderRadius.circular(5),
                                border: Border.all(
                            ...
                            child: Center(
                              child: Text(
                                'Lipa na M-PESA',
                                style: TextStyle(
                                  color: index != 1 ? themeGrey : Colors.white,
                                ),
                              ),
                            ),
                          ),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color:
                                  index == 2 ? themeBlue : Colors.transparent,
                              borderRadius: BorderRadius.circular(5),
                              border:
                                  Border.all(color: themeGrey.withOpacity(.4))),
                          child: Center(
                            child: Text(
                              'M-PESA Paybill',
                              style: TextStyle(
                                color: index != 2 ? themeGrey : Colors.white,
                              ),
                            ),
                          ),
                        ),
